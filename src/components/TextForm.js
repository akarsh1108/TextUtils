 ...
 const [text, setText] = useState('');
  return (
    ...
    <h1 className="mb-2">{props.heading}</h1>
      ...
      <button disabled={text.length===0} className="btn btn-dark mx-2 my-1" onClick={handleUpClick}>Covert to Uppercase</button>
      <button disabled={text.length===0} className="btn btn-dark mx-2 my-1" onClick={handleLoClick}>Covert to Lowercase</button>
